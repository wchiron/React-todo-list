...
class App extends Component {
  ...
  componentDidMount() { //is invoked immediately after a component is mounted (inserted into the tree)
    ...
    axios.get("http://localhost:3000/todo") // use the api on the port 3000 on my own laptop
  ...
  delTodo = (id) => {
    axios.delete(`http://localhost:3000/todo/${id}`) // using back ticks here instead of single quote to be able to use the dollar sign for the id
